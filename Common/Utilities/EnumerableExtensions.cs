...
namespace Hqv.CSharp.Common.Utilities
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Given a source and a list of fields, return only the properties requested in fields.
        /// </summary>
        /// <typeparam name="TSource">Type of the source</typeparam>
        /// <param name="source">List of TSource</param>
        /// <param name="fields">List of comma-delimited fields. If empty, we'll return all properties</param>
